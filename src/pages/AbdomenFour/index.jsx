        ...
        <div className="flex flex-col md:gap-10 gap-[92px] items-center justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-[1700px] mx-auto md:px-5 w-full">
            ...
            <Link to="/demographic">
              ...
              <Link to="/abdomenfour">
              <Button className="cursor-pointer font-medium h-[63px] leading-[normal] text-center text-lg" shape="round" color="white_A700">
                Abdomen </Button> </Link>
...
export default AbdomenFourPage;
