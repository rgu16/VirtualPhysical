    ...
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto w-full">
        <div className="bg-gray-50 flex flex-col justify-start pb-[641px] w-full">
          ...
          <div className="bg-blue-50 flex flex-col font-cairo items-start justify-start mt-11 mx-auto pt-0.5 px-0.5 md:px-5 rounded-[20px] shadow-bs1 w-[55%] md:w-full">
                ...
                <div className="flex flex-col gap-2 items-center justify-start w-full">
                  ...
                  <div className="flex flex-col font-helvetica relative w-full">
                    <div className="flex flex-col gap-[15px] items-center justify-start mx-auto w-full">
                      <div className="flex flex-col items-start justify-start pt-0.5 w-full">
                        ...
                        <Input
                          ...
                          wrapClassName="border border-gray-400 border-solid mt-0.5 w-full"
                        ></Input>
                      </div>
                    ...
                    <Input
                      ...
                      wrapClassName="border border-gray-400 border-solid mt-[-16.59px] mx-auto w-full z-[1]"
                    ></Input>
                  </div>
                </div>
                <button className="bg-indigo-A200 flex flex-col items-center justify-center md:px-10 sm:px-5 px-[93px] rounded-[20px] w-full h-[10vh]">
                  <Text
