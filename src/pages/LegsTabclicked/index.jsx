        ...
        <div className="flex flex-col md:gap-10 gap-[92px] items-center justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-[1700px] mx-auto md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex flex-col font-cairo items-center justify-start p-10 sm:px-5 w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mb-[584px] w-[98%] md:w-full">
                <div className="flex flex-col items-start justify-start md:mt-0 mt-[3px] w-[247px] md:w-full">
                  ...
                  <Img
                    className="h-[35px] mt-6 w-[35px]"
                    src="images/img_user.svg"
                    alt="user"
                  />
                </div>
                <div className="bg-gray-200_01 flex flex-col items-center justify-start mb-[138px] md:ml-[0] ml-[72px] md:mt-0 mt-[11px] p-[17px] rounded-[20px] w-[27%] md:w-full">
...
export default LegsTabclickedPage;
