    ...
    <>
      <div className="bg-white-A700 font-inter h-[1561px] mx-auto pb-[26px] relative w-full">
        ...
        <div className="absolute bg-gray-200_01 flex sm:flex-col flex-row font-dmsans sm:gap-5 items-end justify-start left-[6%] max-w-[1204px] md:px-5 rounded-tl-[12px] rounded-tr-[12px] top-[12%] w-full">
          ...
          <Button
            className="common-pointer cursor-pointer font-medium leading-[normal] min-w-[148px] text-center text-lg"
        ...
        <div className="absolute bg-white-A700 bottom-[8%] flex flex-col font-cairo gap-6 h-[1180px] md:h-auto inset-x-[0] justify-end max-w-[1695px] mx-auto pb-6 pt-8 px-5 rounded-bl-[12px] rounded-br-[12px] w-full">
          ...
          <div className="flex flex-col font-nunito items-start justify-start w-[94%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[87%] md:w-full">
              <div className="flex flex-col items-start justify-start p-3 w-[48%] md:w-full">
              ...
              <Img
                className="h-[35px] md:ml-[0] ml-[226px] md:mt-0 mt-7 w-[35px]"
                src="images/img_profile_black_900_35x35.svg"
                alt="profile"
              />
              <div className="flex flex-col gap-[13px] items-start justify-start ml-9 md:ml-[0] md:mt-0 mt-6 w-[31%] md:w-full">
                <Img
                  className="h-48 md:h-auto object-cover w-[74%]"
                  src="images/img_screenshot20231211.png"
                  alt="screenshot20231"
                />
                <div className="flex flex-col items-center justify-start w-full">
                  <Text
                  ...
                  >
                    Potential sign of liver disease → potential heart disease
                  </Text>
                </div>
              </div>
            </div>
...
export default AbdomenThreePage;
