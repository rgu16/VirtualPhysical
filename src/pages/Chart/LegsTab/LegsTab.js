        ...
        <div className="overlap-15">
          ...
          <div className="overlap-16">
            ...
            <div className="overlap-6">
              <div className="column-titles">
                <p className="scoring">
                  <span className="text-wrapper-16">Scoring</span>
                </p>
                <p className="grade-point">
                  <span className="text-wrapper-16">Grade Point</span>
                </p>
              </div>
              <img className="line-3" alt="Line" src="https://cdn.animaapp.com/projects/65a945881c395bf52b1e3e78/releases/65a9e82814bc0dc531a973f2/img/line-3-1@2x.png" />
              <p className="up-to-of">
              ...
              <p className="element">
                <span className="text-wrapper-18">0</span>
              </p>
              <p className="element-2">
                <span className="text-wrapper-18">+1</span>
              </p>
              <p className="element-3">
                <span className="text-wrapper-18">+2</span>
              </p>
              <p className="element-4">
                <span className="text-wrapper-18">+3</span>
              </p>
            </div>
            ...
            {/* <div className="group-3">
              <img className="chainlink-link" alt="Chainlink link" src="/img/chainlink-link-1.png" />
              <img className="screenshot" alt="Screenshot" src="/img/screenshot-2023-12-06-at-2-58-1-1.png" />
            </div> */}
          ...
          <div className="group-3">
              <img
                ...
                alt="Chainlink link"
                src="https://cdn.animaapp.com/projects/65a945881c395bf52b1e3e78/releases/65a9e82814bc0dc531a973f2/img/chainlink--link--12@2x.png"
              />
              <img
                className="screenshot"
                alt="Screenshot"
                src="https://cdn.animaapp.com/projects/65a945881c395bf52b1e3e78/releases/65a9e82814bc0dc531a973f2/img/screenshot-2023-12-06-at-2-58-1-1@2x.png"
              />
            </div>
