...
const AbdomenOne = React.lazy(() => import("pages/LegsMedPage"));
const Abdomen = React.lazy(() => import("pages/PulsesMedPage"));
const AbdomenFour = React.lazy(() => import("pages/AbdomenMedPage"));
const DemographicOne = React.lazy(() => import("pages/GeneralMedPage"));
const Heart = React.lazy(() => import("pages/HeartMedPage"));
const HandsOne = React.lazy(() => import("pages/HandsMedPage"));
const Hands = React.lazy(() => import("pages/EyesMedPage"));
const Demographic = React.lazy(() => import("pages/DemographicMedPage"));
const Lungs = React.lazy(() => import("pages/LungsMedPage"));
