...
const AbdomenOne = React.lazy(() => import("pages/AbdomenOne"));
const Abdomen = React.lazy(() => import("pages/Abdomen"));
const AbdomenFour = React.lazy(() => import("pages/AbdomenFour"));
const DemographicOne = React.lazy(() => import("pages/DemographicOne"));
const Heart = React.lazy(() => import("pages/Heart"));
const HandsOne = React.lazy(() => import("pages/HandsOne"));
const Hands = React.lazy(() => import("pages/Hands"));
const Demographic = React.lazy(() => import("pages/Demographic"));
const Lungs = React.lazy(() => import("pages/Lungs"));
